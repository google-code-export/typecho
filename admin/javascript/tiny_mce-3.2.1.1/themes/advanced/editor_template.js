...
*/
		...
		_mceColorPicker : function(u, v) {
			...
			ed.windowManager.open({
				...
				height : 278 + parseInt(ed.getLang('advanced.colorpicker_delta_height', 0)),
		...
		_mceImage : function(ui, val) {
			...
			ed.windowManager.open({
				...
				height : 310 + parseInt(ed.getLang('advanced.image_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
		...
		_mceLink : function(ui, val) {
			...
			ed.windowManager.open({
				...
				height : 175 + parseInt(ed.getLang('advanced.link_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
