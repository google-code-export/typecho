            ...
            <div class="column-24 start-01 typecho-list">
                <ul class="typecho-option-tabs">
                    ...
                    <?php if($user->pass('editor', true)): ?>
                        <li class="right<?php if('yes' == Typecho_Request::getParameter('seeAll')): ?> current<?php endif; ?>"><a href="?seeAll=yes"><?php _e('所有人的文章'); ?></a></li>
                        <li class="right<?php if('yes' != Typecho_Request::getParameter('seeAll')): ?> current<?php endif; ?>"><a href="?seeAll=no"><?php _e('我的文章'); ?></a></li>
                    <?php endif; ?>
                </ul>
