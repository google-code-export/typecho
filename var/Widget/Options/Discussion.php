...
class Widget_Options_Discussion extends Widget_Abstract_Options implements Widget_Interface_Action_Widget
{
    ...
    {
        /** 构建表格 */
        $form = new Typecho_Widget_Helper_Form(Typecho_API::pathToUrl('/Options/Discussion.do', $this->options->index),
        ...
        /** 评论日期格式 */
        $commentDateFormat = new Typecho_Widget_Helper_Form_Text('commentDateFormat', $this->options->commentDateFormat,
        ...
        /** 评论列表数目 */
        $commentsListSize = new Typecho_Widget_Helper_Form_Text('commentsListSize', $this->options->commentsListSize,
        ...
        /** 允许使用的HTML标签和属性 */
        $commentsHTMLTagAllowed = new Typecho_Widget_Helper_Form_Textarea('commentsHTMLTagAllowed', htmlspecialchars($this->options->commentsHTMLTagAllowed),
        ...
        /** 在评论中禁止出现的词汇 */
        $commentsStopWords = new Typecho_Widget_Helper_Form_Textarea('commentsStopWords', htmlentities($this->options->commentsStopWords, ENT_NOQUOTES, $this->charset),
        ...
        /** 评论者IP黑名单 */
        $commentsIpBlackList = new Typecho_Widget_Helper_Form_Textarea('commentsIpBlackList', $this->options->commentsIpBlackList,
