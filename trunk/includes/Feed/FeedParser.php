...
class FeedParser{
	...
	private $namespaces     = array(
							'http://purl.org/rss/1.0/'                  => TypechoFeed::RSS1,
							'http://purl.org/rss/1.0/modules/content/'  => TypechoFeed::RSS2,
							'http://www.w3.org/2005/Atom'               => TypechoFeed::ATOM,
	...
	*/   
	...
	{
		$this->url  = $url;
		$response = Typecho::httpRequest($url);
	...
	*/    
	...
	{
		if($this->version == TypechoFeed::RSS1 || $this->version == TypechoFeed::RSS2)
		{
