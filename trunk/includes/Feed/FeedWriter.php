 ...
 */
 class FeedWriter
 {
	...
	*/ 
	function __construct($version = TypechoFeed::RSS2)
	{	
...
xmlns:dc="http://purl.org/dc/elements/1.1/">' . TypechoFeed::EOL;;
	...
	*/
	private function printTale()
	{
		if($this->version == TypechoFeed::RSS2)
		{
			echo '</channel>' . TypechoFeed::EOL . '</rss>'; 
		}    
		elseif($this->version == TypechoFeed::RSS1)
		{
			echo '</rdf:RDF>';
	...
	*/
	...
	{        
		...
		if(is_array($tagContent) && $this->version == TypechoFeed::RSS1)
		{
	...
	*/
	private function printChannels()
	{
		...
		if($this->version == TypechoFeed::RSS1)
		{
			echo "<items>" . TypechoFeed::EOL . "<rdf:Seq>" . TypechoFeed::EOL;
			foreach ($this->items as $item) 
			{
				$thisItems = $item->getElements();
				echo "<rdf:li resource=\"{$thisItems['link']['content']}\"/>" . TypechoFeed::EOL;
			}
			echo "</rdf:Seq>" . TypechoFeed::EOL . "</items>" . TypechoFeed::EOL . "</channel>" . TypechoFeed::EOL;
		}
	}
	...
	*/
	private function startItem($about = false)
	{
		...
		elseif($this->version == TypechoFeed::RSS1)
		{
			if($about)
			{
				echo "<item rdf:about=\"$about\">" . TypechoFeed::EOL;
			}
			else
			{
