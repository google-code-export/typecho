...
class IxrServer {
    ...
    var $message;
    var $capabilities;
    function IxrServer($callbacks = false, $data = false) {
...
class IXR_Client {
    ...
    function query() {
        ...
        $fp = @fsockopen(false !== $this->address ? $this->address : $this->server,
...
class IXR_Date {
    ...
    function getTimestamp() {
        return $this->iso ? (strtotime($this->iso) - date("Z",strtotime($this->iso))) : mktime($this->hour, $this->minute, $this->second, $this->month, $this->day, $this->year);
    }
}
...
class IXR_IntrospectionServer extends IxrServer {
    var $signatures;
    var $help;
