            ...
            <form action="<?php $options->index('Contents/Page/Edit.do'); ?>" method="post" name="write_page">
                <div class="column-18 start-01">
                    <div class="column-18">
                        ...
                        <p><textarea style="height: <?php $options->editorSize(); ?>px" autocomplete="off" id="text" name="text"><?php echo htmlspecialchars(Typecho_Common::beautifyFormat($page->text)); ?></textarea></p>
