...
<head>
    ...
    <title><?php Typecho_API::factory('Widget_Menu')->title(); ?> &raquo; <?php $options->title(); ?> - Powered By Typecho</title>
    ...
    <link href="<?php $options->adminUrl('/js/button/assets/button-core.css'); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php $options->adminUrl('/js/button/assets/skins/sam/button.css'); ?>" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php $options->adminUrl('/js/yuiloader-dom-event/yuiloader-dom-event.js'); ?>" type="text/javascript"></script>
    <script src="<?php $options->adminUrl('/js/element/element-beta-min.js'); ?>" type="text/javascript"></script>
    <script src="<?php $options->adminUrl('/js/button/button-min.js'); ?>" type="text/javascript"></script>
