                    ...
                    <div class="column-18">
                        ...
                        <p class="submit">
                            ...
                            <span class="right">
                                ...
                                <button type="submit" onclick="typechoSubmit('form[name=write_post]', 'input[name=draft]', '0');"><?php if($post->have()): ?><?php _e('更新这篇文章 &raquo;'); ?><?php else: ?><?php _e('发布这篇文章 &raquo;'); ?><?php endif; ?></button>
                            </span>
                        </p>
                    </div>
